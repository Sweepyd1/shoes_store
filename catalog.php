...
<option value="name_asc" <?php if (($_GET['sort'] ?? 'name_asc') == 'name_asc') echo 'selected'; ?>>По названию (А-Я)</option>
...
<span class="price-current"><?php echo number_format($p['price'], 0, '', ' '); ?> ₽</span>
